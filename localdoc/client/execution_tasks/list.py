...
def show_listing_wall(ipc_socket: str, package_dir: str) -> None:
    """Muestra una lista de los paquetes disponibles en la terminal."""
    ...
    served_packages = get_served_packages(ipc_socket)
    for package in get_available_packages(package_dir):
        package_name = Text(
